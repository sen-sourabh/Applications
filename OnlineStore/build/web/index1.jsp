							...
							<% if (session.getAttribute("userid") == null) { %>
								...
								<div><a href="signin.jsp">Sign In</a></div>
                                                        ...
                                                        <% } else {
                                                            ...
                                                            ps = conn.prepareStatement("SELECT user_name, user_email FROM user WHERE user_id=?");
                                                            ps.setInt(1, userid);
                                                            rs = ps.executeQuery();
                                                            while(rs.next()) {
                                                        %>
                                                            <div class="top_bar_user">
                                                                    <div class="user_icon"><img src="images/user.svg" alt=""></div>
                                                                    <div><a href="user_profile.jsp"><%=rs.getString("user_name")%></a></div>
                                                                    <div class="user_icon"><img src="images/logout.png" alt=""></div>
