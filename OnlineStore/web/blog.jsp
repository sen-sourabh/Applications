...
<html lang="en">
<head>
<title> EStore | Featured Brands </title>
<meta charset="utf-8">
...
<!--											<li><a href="#">Italian</a></li>
							...
							<div class="top_bar_user">
								...
								<div><a href="register.jsp">Sign Up</a></div>
                                                                <div class="user_icon"><img src="images/user.svg" alt=""></div>
								<div><a href="signin.jsp">Sign In</a></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="index.jsp">EStore</a></div>
						</div>
					</div>
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									<li><a href="index.jsp">Home<i class="fas fa-chevron-down"></i></a></li>
                                                                        ...
                                                                        <li><a href="featured_brands.jsp">Featured Brands<i class="fas fa-chevron-down"></i></a></li>
<!--									<li class="hassubs">
							...
							<ul class="page_menu_nav">
								<li class="page_menu_item has-children">
									...
									<ul class="page_menu_selection">
										...
										<li><a href="#">Hindi<i class="fa fa-angle-down"></i></a></li>
<!--										<li><a href="#">Spanish<i class="fa fa-angle-down"></i></a></li>
								...
								<li class="page_menu_item">
									<a href="index.jsp">Home<i class="fa fa-angle-down"></i></a>
                                                                ...
                                                                <li class="page_menu_item">
                                                                    <a href="shop.jsp">Shop<i class="fa fa-angle-down"></i></a>
                                                                </li>
                                                                <li class="page_menu_item">
                                                                    <a href="featured_brands.jsp">Featured Brands<i class="fa fa-angle-down"></i></a>
                                                                </li>
<!--								<li class="page_menu_item has-children">
