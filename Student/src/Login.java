...
//        dispose();
    ...
    class OperaBar extends Thread
    {
        JProgressBar jpb;
        String email;
        public OperaBar(JProgressBar jpb, String username)
        {
            this.jpb = jpb;
            this.email = username;
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            st = conn.prepareStatement("SELECT * FROM admin WHERE admin_email=? AND admin_password=?");
            st.setString(1, email);
            st.setString(2, password);
            rs = st.executeQuery();
            if(rs.next()){
                Login.OperaBar op = new Login.OperaBar(jProgressBar1, email);
                op.start();
            }
            else
            {
