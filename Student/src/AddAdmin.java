...
public class AddAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add New Admin", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
        ...
        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AboutStudent.png"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(!isValid(jTextField7.getText())) {
            ...
            String task = "add";
            String admin_adminid = jTextField1.getText();
            ...
            java.util.Date admin_date = new java.util.Date();
            try {
                st = conn.prepareStatement("SELECT * FROM admin WHERE admin_email=? OR admin_adminid=?");
                st.setString(1, admin_email);
                st.setString(2, admin_adminid);
                rs = st.executeQuery();
                if(rs.next()){
                    JOptionPane.showMessageDialog(null, "This Email id/admin id already exist for admin. Please try with different Email id/admin id.");
                    st.close();
                    rs.close();
                }else{
                    ps = conn.prepareStatement("INSERT INTO admin (admin_adminid, admin_name, admin_fathername, admin_email, admin_password, admin_phone, admin_blood, admin_city, admin_image, admin_category, admin_date) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
                    ps.setString(1, admin_adminid);
                    ps.setString(2, admin_name);
                    ps.setString(3, admin_fname);
                    ps.setString(4, admin_email);
                    ps.setString(5, admin_password);
                    ps.setString(6, admin_phone);
                    ps.setString(7, admin_blood);
                    ps.setString(8, admin_city);
                    ps.setBytes(9, photo);
                    ps.setString(10, admin_category);
                    ps.setString(11, admin_date.toString());
                    ps.execute();
                    jTextField1.setText(" ");
                    jTextField2.setText(" ");
                    jTextField3.setText(" ");
                    ...
                    if(SendEmail.sendMail(admin_name, admin_email, admin_password, admin_category, task)) {
                        JOptionPane.showMessageDialog(null, "Admin Details Added and Mail Has Been Sent Successfully.");
                    }else {
                        JOptionPane.showMessageDialog(null, "Admin Details Added But Mail Has Not Been Sent Successfully.");
                    }
                }
