...
public class Operations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student Operations", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 1, 24))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            st = conn.prepareStatement("SELECT std_name, std_email, std_password, std_category FROM student WHERE std_stdid=? LIMIT 1");
            ...
            if(rs.next()){
                ...
                ps = conn.prepareStatement("DELETE FROM student WHERE std_stdid=?");
                ...
                JOptionPane.showMessageDialog(null, "This student id does not exist in our database.");
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(!isValid(jTextField7.getText())) {
            ...
            String std_imagetext = jTextField6.getText();
            String std_category = "student";
            String task = "updated";
            try { 
                ps = conn.prepareStatement("UPDATE student SET std_name=?, std_fathername=?, std_email=?, std_password=?, std_phone=?, std_blood=?, std_city=?, std_image=? WHERE std_stdid=?");
                ps.setString(1, std_name);
                ps.setString(2, std_fname);
                ps.setString(3, std_email);
                ps.setString(4, std_password);
                ps.setString(5, std_phone);
                ps.setString(6, std_blood);
                ps.setString(7, std_city);
                if(photo == null) {
                    photo = std_imagetext.getBytes();
                    ps.setBytes(8, photo);
                }else {
                    ps.setBytes(8, photo);
                }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String std_id = jTextField1.getText();
        try {
            ps = conn.prepareStatement("SELECT std_stdid, std_name, std_email, std_fathername, std_phone, std_city, std_image, std_blood FROM student WHERE std_stdid = ?");
            ps.setString(1, std_id);
            rs = ps.executeQuery();
            if(rs.next()) 
            {
