            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="./user_trash.jsp">Trash <span class="sr-only">(current)</span></a>
                    </li>
                    <!--<li class="nav-item">
                ...
                <table id="mail-table" class="table table-hover common-table">
                    <%
                        ...
                        try {
                            ...
                            db_sql = "SELECT users_xmails_unique_id, users_xmails_user_subject_xmail, "
                                    ...
                                    + "(users_xmails_recievers_users_unique_id=? OR "
                                    + "users_xmails_sender_users_unique_id=?) AND users_xmails_trash_status=1 "
                                    + "AND users_xmails_delete_trash_status=0";
                            PreparedStatement ps = con.prepareStatement(db_sql);
                            ps.setString(1, users_unique_id);
                            ps.setString(2, users_unique_id);
                            ResultSet rs = ps.executeQuery();
                            String page_name1 = "restore";
                            String page_name2 = "delete";
                            String page_name = "trash";
                            while(rs.next()) {
                    ...
                    %>
                                <tr>
                                    ...
                                    <td><i><%=Sent_Date%></i></td>
                                    <td><a class="fa-icon" href="./xmail_trash_action.jsp?xmail_user=<%=rs.getString("users_xmails_unique_id")%>&xmail_page=<%=page_name1%>" title="Open"><i class="fa fa-undo"></i></a></td>
                                    <td><a class="fa-icon" href="./xmail_trash_action.jsp?xmail_user=<%=rs.getString("users_xmails_unique_id")%>&xmail_page=<%=page_name2%>" title="Trash"><i class="fa fa-remove"></i></a></td>
                                </tr>
                    <%
                            }
                        } catch (Exception ex) {
